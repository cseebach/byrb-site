  ...
  return {
    ...
    controller: ($scope, $interval) ->
      ...
      $scope.initializeWindowSize = ->
        ...
        $scope.imageWidth = ($scope.windowWidth * $scope.highlight.width) / 1280.0
        $scope.css.width = $scope.imageWidth + "px"
        $scope.imageHeight = ($scope.windowWidth * $scope.highlight.height) / 1280.0
